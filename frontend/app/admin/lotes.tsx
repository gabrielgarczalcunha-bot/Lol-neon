...
const s = StyleSheet.create({
  ...
  card: { flexDirection: "row", backgroundColor: "#fff", padding: 12, borderRadius: 14, borderWidth: 1, borderColor: C.border, marginBottom: 10 },
  ...
  input: { backgroundColor: "#fff", borderWidth: 1, borderColor: C.border, borderRadius: 12, paddingHorizontal: 12, paddingVertical: 12, color: C.textPrimary },
  switchRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: "#fff", padding: 14, borderRadius: 12, borderWidth: 1, borderColor: C.border, marginBottom: 16 },
